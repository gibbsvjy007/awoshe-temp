...
class ProfileTextAreaInput extends StatelessWidget {
  final IconData icon;
    ...
    return (Container(
        ...
        child: DecoratedBox(
          decoration: BoxDecoration(
              //borderRadius: borderRadius != null ?  BorderRadius.all(Radius.circular(borderRadius)) : BorderRadius.all(Radius.circular(20.0)),
              //border: borderColor == null ? Border.all(color: awLightColor) : Border.all(color: borderColor),
              border: Border(
                  bottom: BorderSide(
                color: awLightColor,
              )),
