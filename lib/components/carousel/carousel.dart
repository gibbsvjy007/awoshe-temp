...
class CarouselState extends State<Carousel> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> listImages = widget.fromMemory
        ? []
        : widget.images
    ...
    final List<Widget> listMemoryImages = widget.images
        .map((memImage) => Container(
              child: (memImage is String) ? Text(memImage) :  AssetView(asset: memImage,),
            ))
        .toList();
        ...
        children: <Widget>[
          new Container(
            child: new PageView(
              ...
              children: widget.fromMemory ? listMemoryImages : listImages,
            ),
          ),
                  ...
                  child: new Container(
                    ...
                    child: new Center(
                      child: new DotsIndicator(
                        controller: _controller,
                        itemCount: widget.fromMemory
                            ? listMemoryImages.length
                            : listImages.length,
