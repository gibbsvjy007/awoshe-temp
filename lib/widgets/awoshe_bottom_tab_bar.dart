...
const double _kTabBarHeight = 44.0;
...
///
/// Displays multiple tabs using [AwBottomNavigationBarItem] with one tab being
...
///  * [AwBottomNavigationBarItem], an item in a [CupertinoTabBar].
class AwCupertinoTabBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  ///
  /// Must not be null.
  final List<AwBottomNavigationBarItem> items;
  ...
  /// The foreground color of the icon and title for the [AwBottomNavigationBarItem]
  /// of the selected tab.
  final Color activeColor;

  /// The foreground color of the icon and title for the [AwBottomNavigationBarItem]s
  /// in the unselected state.
  final Color inactiveColor;

  /// The size of all of the [AwBottomNavigationBarItem] icons.
  ///
  /// This value is used to to configure the [IconTheme] for the navigation
  /// bar. When a [AwBottomNavigationBarItem.icon] widget is not an [Icon] the widget
...
//                      Expanded(child: Center(child: items[index].icon)),
                        Expanded(child: new Center(child: active ? items[index].activeIcon : items[index].icon)),
//                      items[index].title, TODO - create different widget function to support with icon
                    ],
                  ),
//                ),
              ),
  ...
  AwCupertinoTabBar copyWith({
    Key key,
    List<AwBottomNavigationBarItem> items,
    Color backgroundColor,
    Color activeColor,
    Color inactiveColor,
    Size iconSize,
