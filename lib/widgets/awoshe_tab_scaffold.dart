...
import 'awoshe_bottom_tab_bar.dart';
...
class AwCupertinoTabScaffold extends StatefulWidget {
  ...
  /// If [CupertinoTabBar.onIndexSelected] is provided, it will still be called.
  ...
  ///
  /// Must not be null.
  final AwCupertinoTabBar tabBar;
  ...
  @override
  _AwCupertinoTabScaffoldState createState() => _AwCupertinoTabScaffoldState();
}

class _AwCupertinoTabScaffoldState extends State<AwCupertinoTabScaffold> {
  int _currentPage;
  ...
  @override
  void didUpdateWidget(AwCupertinoTabScaffold oldWidget) {
