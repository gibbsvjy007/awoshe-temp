...
class AwosheSegmentedControl<T> extends StatefulWidget {
  ...
  AwosheSegmentedControl({
    ...
    this.awWhite = Colors.white,
    this.pressedColor = awLightColor,
...
class _SegmentedControlState<T> extends State<AwosheSegmentedControl<T>>
    with TickerProviderStateMixin<AwosheSegmentedControl<T>> {
  T _pressedKey;
  ...
  @override
  void didUpdateWidget(AwosheSegmentedControl<T> oldWidget) {
...
class _RenderSegmentedControl<T> extends RenderBox
  ...
  void _layoutRects(_NextChild nextChild, RenderBox leftChild, RenderBox rightChild) {
    ...
    while (child != null) {
      ...
      RRect rChildRect;
      if (child == leftChild) {
        rChildRect = RRect.fromRectAndCorners(childRect, topLeft: const Radius.circular(20.0),
            bottomLeft: const Radius.circular(20.0));
      } else if (child == rightChild) {
        rChildRect = RRect.fromRectAndCorners(childRect, topRight: const Radius.circular(20.0),
