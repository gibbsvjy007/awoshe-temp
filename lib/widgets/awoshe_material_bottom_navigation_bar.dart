...
/// Defines the layout and behavior of a [AwBottomNavigationBar].
///
/// See also:
///
///  * [BottomNavigationBar]
...
enum AwBottomNavigationBarType {
...
class AwBottomNavigationBar extends StatefulWidget {
  ...
  AwBottomNavigationBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
    AwBottomNavigationBarType type,
    this.fixedColor,
    this.iconSize = 22.0,
  })  : assert(items != null),
  ...
  /// of different types.
  final AwBottomNavigationBarType type;
  ...
  @override
  _AwBottomNavigationBarState createState() => _AwBottomNavigationBarState();
}
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final AwBottomNavigationBarType type;
  final AwBottomNavigationBarItem item;
  ...
  Widget _buildIcon() {
    ...
    Color iconColor;
    switch (type) {
      case AwBottomNavigationBarType.fixed:
        tweenStart =  Platform.isAndroid ? 16.0 : 10.0;
        iconColor = colorTween.evaluate(animation);
        break;
      case AwBottomNavigationBarType.shifting:
        tweenStart = 16;
    ...
    return Align(
      ...
      child: Container(
        margin: EdgeInsets.only(
          //TODO Change this based on platform, if 10 isn't looking good on android. we once changed it to tweenStart value above but that condition isn't working
          top: tweenStart,
        ),
        child: IconTheme(
          data: IconThemeData(
...
class _AwBottomNavigationBarState extends State<AwBottomNavigationBar>
  ...
  @override
  void didUpdateWidget(AwBottomNavigationBar oldWidget) {
...
class _Circle {
  ...
  final _AwBottomNavigationBarState state;
  final int index;
  final Color color;
