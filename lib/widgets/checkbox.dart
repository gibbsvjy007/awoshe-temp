...
class AwCheckbox extends StatefulWidget {
  ...
  ///
  /// AwCheckbox displays a dash when its value is null.
  ///
  ...
  @override
  _AwCheckboxState createState() => _AwCheckboxState();
}

class _AwCheckboxState extends State<AwCheckbox> with TickerProviderStateMixin {
  @override
...
const double _kEdgeSize = Checkbox.width ?? 18.0;
