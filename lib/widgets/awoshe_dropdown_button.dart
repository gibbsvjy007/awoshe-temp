...
class AwosheDropdownButton<T> extends StatefulWidget {
  ...
  @override
  _AwosheDropdownButtonState<T> createState() => _AwosheDropdownButtonState<T>();
}

class _AwosheDropdownButtonState<T> extends State<AwosheDropdownButton<T>> with WidgetsBindingObserver {
  int _selectedIndex;
  ...
  @override
  void didUpdateWidget(AwosheDropdownButton<T> oldWidget) {
